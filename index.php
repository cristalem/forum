...
include_once 'function/addPost.class.php';/*on recupere les fonction dont on a besoin*/
$bdd = bdd();
 ...
 <h1>Bienvenue sur mon forum !</h1>
            ...
            <div id="Cforum">
                ...
                while($reponse = $requete->fetch()){
                    ?>
                     <div class="categories">
                        <p> <a href="index.php?sujet=<?php echo $reponse['name'] ?>"><h1><?php echo $reponse['name'] ?></h1></a> </p>
                    </div>
                    <?php
                }
                ?>
                ...
                <div class="post">
                    <?php 
                     $requete2 = $bdd->prepare('SELECT * FROM membre WHERE id = :id');
